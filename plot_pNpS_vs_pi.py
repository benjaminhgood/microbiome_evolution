...
#species_names = ["Roseburia_intestinalis_56239"]
#species_names = ["Eubacterium_eligens_61678"]
...
for species_name in species_names:
    ...
    pylab.savefig('figures/%s_pNpS_vs_pi.pdf' % species_name,bbox_inches='tight')
    ...
    pylab.savefig('figures/%s_fst_vs_pi.pdf' % species_name,bbox_inches='tight')
    ...
    pylab.savefig('figures/%s_pi_between_vs_within.pdf' % species_name,bbox_inches='tight')
    pylab.savefig('figures/%s_pi_between_vs_within.png' % species_name,bbox_inches='tight', dpi=300)
    ...
    pylab.savefig('figures/%s_fixation_vs_pi_%0.1f.pdf' % (species_name, min_change),bbox_inches='tight')
    pylab.savefig('figures/%s_fixation_vs_pi_%0.1f.png' % (species_name, min_change),bbox_inches='tight', dpi=300)
    ...
    pylab.savefig('figures/%s_pi_vs_coverage.pdf' % species_name, bbox_inches='tight')
