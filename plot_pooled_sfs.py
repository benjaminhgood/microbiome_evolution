...
for species_name in species_names:
    ...
    samples, allele_counts_map, passed_sites_map = parse_midas_data.parse_snps(species_name, combination_type="sample", debug=True)
    sys.stderr.write("Done!\n")
    ...
    pylab.savefig('figures/%s_pooled_sfs.pdf' % species_name, bbox_inches='tight')
    pylab.savefig('figures/%s_pooled_sfs.png' % species_name, bbox_inches='tight', dpi=300)
