...
for species_name in species_names:
    ...
    pylab.savefig('figures/%s_intragene_ld.pdf' % species_name, bbox_inches='tight')
    pylab.savefig('figures/%s_intragene_ld.png' % species_name, bbox_inches='tight', dpi=300)
